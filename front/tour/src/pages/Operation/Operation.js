...
export default function Operation(props) {
    const {enActive,flushDetail,changePosition,vehicle,roads} = props
                ...
                <div className={Style["path-detail"]} ref={pathDetailRef}>
                    <div className={Style["head"]}>
                        <i className={["iconfont", "icon-xiangzuojiantou", `${Style["icon"]}`].join(' ')}
                           onClick={(e)=>{pathDetailRef.current.classList.remove(Style["show"])}}>
                            返回
                        </i>
                    </div>
                    <div className={Style["paths"]}>
                        {
                            path.map((id) => {
                                ...
                                const road = roads.find((e)=>{return  e.id === id})
                                return (
